...
for i in range(0, 20):
    GPIO.output(c1, 1)
    GPIO.output([c2,c3,c4,c5,c6,c7], 0)
    time.sleep(0.2)
    GPIO.output(c2, 1)
    GPIO.output([c1,c3,c4,c5,c6,c7], 0)
    time.sleep(0.2)
    GPIO.output(c3, 1)
    GPIO.output([c1,c2,c4,c5,c6,c7], 0)
    time.sleep(0.2)
    GPIO.output(c4, 1)
    GPIO.output([c1,c2,c3,c5,c6,c7], 0)
    time.sleep(0.2)
    GPIO.output(c5, 1)
    GPIO.output([c1,c2,c3,c4,c6,c7], 0)
    time.sleep(0.2)
    GPIO.output(c6, 1)
    GPIO.output([c1,c2,c3,c4,c5,c7], 0)
    time.sleep(0.2)
    # GPIO.output(c7, 1)
